...
RegisterCommand("gg", function(source)
    ...
    if GetPlayerRoutingBucket(source) < 900000 and Passport and SURVIVAL.CheckDeath(source) then
        ...
        if vRP.HasGroup(Passport,"Rubi") then
        elseif vRP.HasGroup(Passport,"NovaModa") then
        elseif vRP.HasGroup(Passport,"Patrpciandor") then 
        ...
        TriggerEvent("inventory:CarryDetachDeath",source)
