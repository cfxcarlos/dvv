...
AddStateBagChangeHandler("SetDiscord",nil,function(Name,Key,Value)
	SetDiscordAppId(1221947479315189810)
	SetDiscordRichPresenceAsset("instanovamoda")
	SetDiscordRichPresenceAssetText("Nova Moda RJ")
	SetDiscordRichPresenceAssetSmall("developer")
	SetDiscordRichPresenceAssetSmallText("Nova Moda RJ")
	SetDiscordRichPresenceAction(0,"Jogar","fivem://connect/cfx.re/join/dvv34q")
	SetDiscordRichPresenceAction(1,"Social","https://discord.gg/c2cWJ6S3")
