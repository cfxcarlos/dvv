...
local List = {
	["Mecanica"] = {
		...
		["List"] = {
			...
			["2"] = { item = "toolbox", price = 10000, amount = 1 },
			["3"] = { item = "tyres", price = 10000, amount = 1},
			["4"] = { item = "plate", price = 10000, amount = 1 },
			["5"] = { item = "nitro", price = 50000, amount = 1 },
			["6"] = { item = "WEAPON_WRENCH", price = 10000, amount = 1 },
			["7"] = { item = "pliers", price = 1000, amount = 1 },
			["8"] = { item = "screwdriver", price = 10000, amount = 1 },
		}
	},
	["Mec"] = {
		["Mode"] = "Buy",
		["List"] = {
			...
			["3"] = { item = "tyres", price = 1000, amount = 1},
			["4"] = { item = "plate", price = 1000, amount = 1 },
			["5"] = { item = "nitro", price = 35000, amount = 1 },
			["6"] = { item = "WEAPON_WRENCH", price = 1000, amount = 1 },
			["7"] = { item = "pliers", price = 1000, amount = 1 },
			["8"] = { item = "screwdriver", price = 1000, amount = 1 },
		}
	},
	["Matuto"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "AMMO_9", price = 100, amount = 1 },
			["2"] = { item = "AMMO_762", price = 150, amount = 1 },
			["3"] = { item = "AMMO_556", price = 150, amount = 1},
			["4"] = { item = "WEAPON_ARPLATINA", price = 260000, amount = 1 },
			["5"] = { item = "WEAPON_ARFULAN", price = 220000, amount = 1 },
			["6"] = { item = "WEAPON_AR15TCP", price = 260000, amount = 1 },
			["7"] = { item = "WEAPON_AR15PRETO", price = 230000, amount = 1 },
			["8"] = { item = "WEAPON_AR10PRETO_RELIKIASHOP", price = 230000, amount = 1 },
			["8"] = { item = "WEAPON_AR15BEGE_RELIKIASHOP", price = 250000, amount = 1 },
			["9"] = { item = "WEAPON_ARPENTEACRILICO_RELIKIASHOP", price = 280000, amount = 1 },
			["10"] = { item = "WEAPON_ARLUNETAPRATA", price = 300000, amount = 1 },
			["11"] = { item = "WEAPON_ARTAMBOR", price = 280000, amount = 1 },
			["12"] = { item = "WEAPON_G3LUNETA_RELIKIASHOP", price = 230000, amount = 1 },
			["13"] = { item = "WEAPON_HKG3A3", price = 120000, amount = 1 },
			["14"] = { item = "WEAPON_HK_RELIKIASHOP", price = 140000, amount = 1 },
			["15"] = { item = "WEAPON_PENTEDUPLO1", price = 300000, amount = 1 },
			["16"] = { item = "WEAPON_tirica", price = 280000, amount = 1 },
			["17"] = { item = "WEAPON_CARBINERIFLE_MK2", price = 250000, amount = 1 },
			["18"] = { item = "WEAPON_AKPENTEDE90_RELIKIASHOP", price = 300000, amount = 1 },
			["19"] = { item = "WEAPON_AKDEFERRO_RELIKIASHOP", price = 280000, amount = 1 },
			["20"] = { item = "WEAPON_AK472", price = 150000, amount = 1 },
			["21"] = { item = "WEAPON_FALAMERICA", price = 310000, amount = 1 },
			["22"] = { item = "WEAPON_falbatman", price = 220000, amount = 1 },
			["23"] = { item = "WEAPON_GLOCKDEROUPA_RELIKIASHOP", price = 120000, amount = 1 },
			["24"] = { item = "WEAPON_GLOCKMENGO", price = 80000, amount = 1 },
			["25"] = { item = "WEAPON_GLOCK18C", price = 130000, amount = 1 },
			["26"] = { item = "barricada4", price = 5000, amount = 1 },
			["27"] = { item = "vest", price = 50000, amount = 1 },
			["28"] = { item = "joint", price = 500, amount = 1 },
			["29"] = { item = "lanca", price = 500, amount = 1 },
			["30"] = { item = "lsd", price = 500, amount = 1 },
			["31"] = { item = "cocaine", price = 800, amount = 1 },
			["32"] = { item = "drugtable", price = 20000, amount = 1 },
		}
	},
	["Prision"] = {
		["Mode"] = "Buy",
	...
	["Turano"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "hotdog", price = 25, amount = 1 },
			["2"] = { item = "cola", price = 15, amount = 1 }, 
		}
	},
	["mecanica"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "hotdog", price = 25, amount = 1 },
			["2"] = { item = "spaghetti", price = 15, amount = 1 }, 
			["3"] = { item = "passionjuice", price = 10, amount = 1 }, 
		}
	},
	["Pharmacy"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "medkit", price = 2000, amount = 1 },
			["2"] = { item = "bandage", price = 500, amount = 1 },
			["3"] = { item = "gauze", price = 500, amount = 1},
			["4"] = { item = "analgesic", price = 300, amount = 1 },
			["5"] = { item = "adrenaline", price = 10000, amount = 1 },
		}
	},
	["Paramedic"] = {
		["Mode"] = "Buy",
		...
		["List"] = {
			...
			["6"] = { item = "bandage", price = 100, amount = 1 },
			["7"] = { item = "gauze", price = 50, amount = 1 },
			["8"] = { item = "gdtkit", price = 20, amount = 1 },
			["9"] = { item = "medkit", price = 150, amount = 1 },
			["10"] = { item = "sinkalmy", price = 150, amount = 1 },
			["11"] = { item = "analgesic", price = 50, amount = 1 },
			["12"] = { item = "ritmoneury", price = 150, amount = 1 },
			["13"] = { item = "defibrillator", price = 150, amount = 1 },
			["14"] = { item = "medicbag", price = 150, amount = 1 },
		}
	},
	["Attachs"] = {
		["Mode"] = "Buy",
		["Permission"] = "Attachs",
		["List"] = {
			["1"] = { item = "ATTACH_FLASHLIGHT", price = 1, amount = 1 },
			["2"] = { item = "ATTACH_CROSSHAIR", price = 1, amount = 1 },
			["3"] = { item = "ATTACH_MAGAZINE", price = 1, amount = 1},
			["4"] = { item = "ATTACH_SILENCER", price = 1, amount = 1 },
			["5"] = { item = "ATTACH_GRIP", price = 1, amount = 1 },
		}
	},
	["Spray"] = {
		["Mode"] = "Buy",
	...
	["Ammunation"] = {
		...
		["List"] = {
			...
			["9"] = { item = "GADGET_PARACHUTE", price = 20000, amount = 1 },
		}
	},
	["Hamburger"] = {
		["Mode"] = "Buy",
	...
	["Tools"] = {
		...
		["List"] = {
			...
			["26"] = { item = "backpackp", price = 2000, amount = 1 },
			["27"] = { item = "backpackm", price = 3000, amount = 1 },
			["28"] = { item = "backpackg", price = 5000, amount = 1 },
		}
	},
--[[ 	["Mega"] = {
		["Mode"] = "Buy",
	...
	["Armory5"] = {
		...
		["Permission"] = "Policia",
		["List"] = {
			["1"] = { item = "WEAPON_CARBINERIFLE_MK2", price = 500, amount = 1 },
			["2"] = { item = "WEAPON_PARAFAL", price = 500, amount = 1 },
			["3"] = { item = "WEAPON_FNFAL", price = 500, amount = 1 },
			["4"] = { item = "WEAPON_FNL1A1", price = 500, amount = 1 },
			["5"] = { item = "WEAPON_SMG", price = 500, amount = 1 },
			["6"] = { item = "WEAPON_PUMPSHOTGUN", price = 500, amount = 1 },
			["7"] = { item = "WEAPON_CARBINERIFLE", price = 500, amount = 1 },
			["8"] = { item = "vest", price = 250, amount = 1 },
			["9"] = { item = "handcuff", price = 300, amount = 1 },
			["10"] = { item = "barrier", price = 5, amount = 1 },
			["11"] = { item = "radio", price = 250, amount = 1 },
			["12"] = { item = "WEAPON_NIGHTSTICK", price = 500, amount = 1 },
			["13"] = { item = "WEAPON_SMOKEGRENADE", price = 50, amount = 1 },
			["14"] = { item = "laptop", price = 25, amount = 1 },
			["15"] = { item = "AMMO_9", price = 25, amount = 1 },
			["16"] = { item = "AMMO_45", price = 25, amount = 1 },
			["17"] = { item = "AMMO_556", price = 25, amount = 1 },
			["18"] = { item = "AMMO_12", price = 25, amount = 1 },
			["19"] = { item = "WEAPON_GLOCK22", price = 500, amount = 1 },
			["20"] = { item = "WEAPON_ARDELUNETA_RELIKIASHOP", price = 3500, amount = 1 },
			["21"] = { item = "AMMO_762", price = 25, amount = 1 },
			["22"] = { item = "AMMO_308", price = 250, amount = 1 },
		}
	},
	...
	["Clothes"] = {
		...
		["List"] = {
			...
			["4"] = { item = "GADGET_PARACHUTE", price = 475, amount = 1 },
		}
	},
	["Materials"] = {
		["Mode"] = "Buy",
				...
				if vRP.MaxItens(Passport,Item,Amount) then
					...
					if (vRP.InventoryWeight(Passport) + itemWeight(Item) * Amount) <= vRP.GetWeight(Passport) then
						if vRP.PaymentFull(Passport,List[Shop]["List"][Slot]["price"] * Amount, Amount.."x("..itemName(Item)..")") then
							if Shop == "Pmerj" and Item == "WEAPON_PISTOL" then
								...
								if Shop == "Matuto" then
									...
									local Identity = vRP.Identity(Passport)
									local webdrops = "/webhooks/1261940435505385522/LomNm2cMFwoZEGHg0Z-w15ENdqVgdktox4ykN0Pcwd5CIBBPd1KOY99WFcD01DaJkWBK"
									SendWebhookMessage(webdrops, "```".. (Identity["name"].." "..Identity["name2"]) .." [".. Passport .."] comprou x"..Amount.."("..itemName(Item)..") na cds ("..mathLength(Coords.x)..","..mathLength(Coords.y)..","..mathLength(Coords.z)..").```")
