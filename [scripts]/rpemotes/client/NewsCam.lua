...
if Config.NewscamEnabled then
    ...
    function SetMsgBottomTitle()
        ...
        AddTextEntry("top", "Digite a mensagem principal da notícia") 
        ...
        AddTextEntry("bottom", "Digite o título inferior da notícia")
        ...
        AddTextEntry("title", "Digite o título da notícia")
