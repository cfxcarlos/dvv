...
const Fe = "" + new URL("xj6.png", import.meta.url).href,
  Ie = "" + new URL("civictyper.png", import.meta.url).href,
  Ke = "" + new URL("150.png", import.meta.url).href;
function J(e, t, n) {
  const r = e.slice();
  return (
    (r[4] = t[n].index),
...
function We(e, t, n) {
  let r = location.port === "5173" || !1,
    i = [
      ...
      { index: "150", title: "150", subtitle: "Honda", photo: Ke },
    ];
  Se("Open", () => n(0, (r = !0)));
  async function s(u) {
