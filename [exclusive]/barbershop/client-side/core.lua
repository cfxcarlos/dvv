...
local Locations = {
	...
	vec3{ 1939.39, 74.67, 188.62 }, -- manguinhos
	vec3{ 1575.58, 1450.05, 111.17 }, --TURANO
	vec3{ -1717.0, -135.3, 85.7, }, -- PENHA DO DA PENHA
	vec3{ 1420.48, -219.25, 177.8 }, -- CASTELAR CL
    vec3{ -1043.94,-2792.17,21.33 },
	vec3{ 1447.51, -804.11, 112.91 }, -- Egito
	vec3{ 1892.43,6388.96,76.18,357.17 }, -- Vila Kennedy
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
