...
function FinishWorking()
    ...
    TriggerEvent("Notify", "azul", "Você terminou as <b>Cobranças</b>.", 5000)
end
                        ...
                        if Dist <= 0.7 then
                            ...
                            if IsControlJustPressed(1,38) and not IsPedInAnyVehicle(Ped) then
                                if SERVER_TUNNEL.CheckHouseDelay(k) then
                                    WorkingAtHome = k
                                    TriggerEvent("Notify", "amarelo", "Você está cobrando a casa <b>" .. WorkingAtHome .. "</b>.", 5000)
                        ...
                        if Dist <= 1.5 then
                            if IsControlJustPressed(0,38) and not IsPedInAnyVehicle(Ped) then
                                ...
                                if GetServicesComplete() >= #Config.Homes[WorkingAtHome]["services"] then
                                    ...
                                    TriggerEvent("Notify", "Sucesso", "Você terminou a cobrança na casa <b>" .. WorkingAtHome .. "</b>.", 5000)
                                    FinishService()
                                else
                                    TriggerEvent("Notify", "amarelo", "Continue cobrando as casas.", 5000)
                                end
                            end
                        end
                    end
