...
local List = {
	...
	{ -- Matuto
		Distance = 20,
		Coords = { 1742.41,-1637.47,112.52,11.34 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Matuto
		Distance = 20,
		Coords = { 2475.87,-384.17,94.39,257.96 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Matuto
		Distance = 20,
		Coords = { 2790.28,1460.58,24.48,85.04 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Matuto
		Distance = 20,
		Coords = { 2885.41,4387.34,50.73,195.6 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Matuto
		Distance = 20,
		Coords = { 44.05,6303.75,31.22,195.6 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Matuto
		Distance = 20,
		Coords = { -567.38,5252.98,70.47,68.04 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Matuto
		Distance = 20,
		Coords = { -1096.93,-1680.34,4.36,119.06 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Matuto
		Distance = 20,
		Coords = { 501.86,-1966.0,24.99,102.05 },
		Model = "g_f_y_ballas_01",
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Ilegal
	...
	{ -- Mercado Central 
		Distance = 20,
		Coords = { 46.73,-1749.73,29.62,51.03 },
		Model = "ig_cletus",
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
--[[ 	{ -- Mercado Central
