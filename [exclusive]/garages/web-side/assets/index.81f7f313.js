...
`,
  jc = me.button` 
    ...
    color: ${(e) =>
      e.city ? "rgba(255, 0, 0, 0.702)" : "rgba(255, 0, 0, 0.702)"};
...
`,
  ...
  aS = me.button` 
    ...
    svg {
        ...
        stroke: ${(e) =>
          e.city ? "rgba(255, 0, 0)" : "rgba(255, 0, 0)"};
    }

    :hover {
        background: ${(e) =>
          e.city ? "rgba(204, 67, 67)" : "rgba(204, 67, 67)"};
...
const wS = "http://26.241.92.143/vehicles/";
...
`,
  VS = me(DS)` 
    ...
    background: ${(e) =>
      e.city ? "rgba(15, 15, 15)" : "rgba(15, 15, 15)"};
