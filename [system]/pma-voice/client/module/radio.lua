	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			if LoadAnim("radioanimation") then
				...
				Object = CreateObject('prop_cs_hand_radio',Coords["x"],Coords["y"],Coords["z"], true, true, true)
				AttachEntityToEntity(Object,Ped,GetPedBoneIndex(Ped,60309),0.08,0.05,0.003,-50.0,160.0,740.0,true,true,false,true,1,true)
			end
